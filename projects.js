 // ============================================================
            ...
            async function createUser() {
                ...
                const { data, error } = await supabaseClient.auth.signUp({
                    ...
                    password: password,
                    options: {
                        // C'est ici qu'on envoie les métadonnées
                        data: {
                ...
                if (error) {
                    ...
                    // Note: Si "Confirm Email" est activé dans Supabase, l'utilisateur ne pourra pas se connecter tout de suite.
                    alert("✅ Utilisateur créé ! S'il ne peut pas se connecter, vérifiez si un mail de confirmation a été envoyé.");
                    resetAccView();
                }
            }
            ...
            async function loadUsersList() {
                ...
                // On récupère la liste depuis la table 'profiles'
            ...
            async function deleteUserProfile(id) {
                if (!confirm("Voulez-vous supprimer ce profil de l'affichage ? (L'accès login devra être coupé sur Supabase)")) return;
